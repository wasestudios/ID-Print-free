<?php
// Configurar CORS antes de cualquier output
...
$app->group('/templates', function ($group) {
    ...
    $group->get('/export', [TemplateController::class, 'exportTemplates']);
    $group->post('/import', [TemplateController::class, 'importTemplates']);
